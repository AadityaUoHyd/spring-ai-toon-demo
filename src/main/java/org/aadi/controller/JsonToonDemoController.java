...
import org.aadi.dto.UserProfile;
    ...
    public Map<String, Object> compareJsonVsToon() {
        ...
        try {
            ...
            UserProfile profile = new UserProfile(
                    ...
                    32,
                    "India",
                    List.of("Spring Boot", "Databases", "Microservices", "DSA", "Kafka", "ReactJs", "Kubernetes"),
                    new UserProfile.Address("Banjara Hills Road", "Hyderabad", "500034")
            );
